<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WaterSDayReport.aspx.vb" Inherits="WaterSDayReport" %>
                ...
                <table style="width:900px">
                   <tr>
                    <td  style="text-align:center;">
                        <asp:Label ID="Label2" runat="server" Text="紀錄查詢" Font-Bold="true" Font-Size="22px"></asp:Label>
                    </td>
                   </tr>
                   <tr>
                    <td>
                       <asp:Label ID="Label1" runat="server" Text="查詢區間：" Font-Bold="true" Font-Size="14px"></asp:Label>
                       <asp:Label ID="Label5" runat="server" Text="查詢區間：" Font-Bold="true" Font-Size="14px"></asp:Label>
                        
                        <asp:TextBox ID="txtDateS" runat="server" Width="70px" BackColor="White" ForeColor="Black"></asp:TextBox>
