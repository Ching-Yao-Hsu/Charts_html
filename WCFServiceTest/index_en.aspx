...
<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="_Default" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function colorbox_Chart() {
            ...
            if (session == "null") {
                alertify.alert("Sign timed out. Please sign in again!");
                ...
                if (treeViewData.selectedNodeID.value != "") {
                    ...
                    alertify.alert("Please select Meter!");
                }
            }
        }
    </script>
...
<%   Session("language") = "en"%>
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label1" runat="server" Text="Instant Electricity Value" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                                            ...
                                            <table>
                                                <tr>
                                                    <td align="left" colspan="4" nowrap="nowrap">
                                                        <img src="img/icon-account.png" />Group-<%=Session("language") %>
                            ...
                            <td colspan="3" valign="top">
                                <asp:Panel ID="Panel_Data" runat="server">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Panel ID="Panel2" runat="server" Width="425px" Height="276px" BackImageUrl="~/img/power_panel2en.jpg">
                                                            ...
                                                            <td width="115px" height="60px">
                                                                <div style="position: relative; padding-left: 0px; padding-top: 0px; width: 110px;">
                                                                    <asp:ImageButton ID="PowerChart" runat="server" OnClientClick="colorbox_Chart()"
                                                                        CssClass="imageButtonFinderClass" ImageUrl="~/img/pe2en.gif" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                <asp:RadioButtonList ID="item_RBList" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem Value="I">Current</asp:ListItem>
                                    <asp:ListItem Value="V">Voltage</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td align="left">
                                <asp:Button ID="ChangeSeries_btn" runat="server" Text="Display" OnClientClick="return false;" />
                            </td>
                        </tr>
                        <tr>
