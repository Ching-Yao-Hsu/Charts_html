    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=img_btn.ClientID%>").click(function () {
                var today = new Date();
                var fileName = '多電表比重圖_' + today.getFullYear() + '_' + (today.getMonth() + 1) + '_' + today.getDate() + '.png';
                    ...
                    <tr>
                        <td>
                            <jqChart:Chart ID="Chart_ES" Width="550px" Height="330px" runat="server" Visible="false">
                                ...
                                <Title Text="多電表比重圖"></Title>
                                <Border StrokeStyle="#6ba851" />
                                <Legend><Title Text="比對電表"></Title></Legend>
                        ...
                        <td align="left" valign="top" style="padding-top: 20px; padding-left: 10px;" nowrap="nowrap">
                            <asp:Panel ID="analysis_panel" runat="server" GroupingText="效益分析" Visible="false">
