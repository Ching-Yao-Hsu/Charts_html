<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SummaryMonthReport.aspx.vb" Inherits="SummaryMonthReport" %>
            ...
            <asp:Panel ID="Panel_Report" runat="server">
                <div id="Print_Table" class="inner" style="padding-left: 0px;">
                    <table>
                        <%--<tr>
                            <td align="center">
                                <asp:Label ID="Label1" runat="server" Text="台灣國際造船股份有限公司 - 基隆廠" Font-Bold="true" Font-Size="22px"></asp:Label>
                            </td>
                        </tr>--%>
                        <tr>
                            <td align="center">
                                <asp:Label ID="Label2" runat="server" Text="總月報表" Font-Bold="true" Font-Size="22px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
