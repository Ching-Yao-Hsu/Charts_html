<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="PowerMonthReport.aspx.vb" Inherits="PowerMonthReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            var HrefAddress = "support/PowerMonthReportSupport.htm";
            $('.support').colorbox({ innerWidth: 700, innerHeight: 600, iframe: true, slideshow: true, scrolling: true, overlayClose: false, href: HrefAddress });
            //月曆
                ...
                if ($("#<%= Date_txt.ClientID%>").val() != "") {
                    ...
                    if (j > 0) {
                        if (j <= 10) {
                            ...
                            var HrefAddress = "MonthReport_en.aspx?group=" + group + "&node=" + node + "&datetime=" + datetime + "&interval=" + interval;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="Monthly Report" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                        ...
                        <table>
                            <tr>
                                <td align="left" width="200px">
                                    ...
                                    <asp:TextBox ID="Date_txt" runat="server" Width="50px" BackColor="White" ForeColor="Black"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="height: 50px; padding-top: 5px;">
                                        <asp:ImageButton ID="ViewDetails_btn" runat="server" ImageUrl="~/img/btn_monthreport_01en.png"
                                            onmouseover="this.src='img/btn_monthreport_02en.png'" onmouseout="this.src='img/btn_monthreport_01en.png'"
