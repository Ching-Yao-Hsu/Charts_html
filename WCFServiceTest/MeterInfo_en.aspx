<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="MeterInfo.aspx.vb" Inherits="TreeSetting" MaintainScrollPositionOnPostback="true" %>
        ...
        function chkLineNum() {
            ...
            if (LineNum != '') {
                ...
                if (regex.test(LineNum) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>One-Line Diagram Number contains illegal characters.</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
        ...
        <table>
            <tr>
                <td align="left" style="padding-left:5px;">
                    <asp:label id="Label4" runat="server" text="Meter Setting" font-bold="True" font-size="16pt" cssclass="fontline"></asp:label>
                </td>
                                ...
                                <tr>
                                    <td colspan="2" style="padding-left: 10px">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Group_DropDownList"
                                            ErrorMessage="Please select group" InitialValue="0" Display="None"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="2">
                                            ...
                                            <table>
                                                <tr>
                                                    <td align="left" valign="middle" colspan="4">
                                                        <div class="title_div">
                                                            <asp:Label ID="Label3" Width="190px" runat="server" Text="Meter information" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap="nowrap" colspan="4">
                                                        ...
                                                        <asp:Button ID="draw_btn" runat="server" Text="Loading" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Panel ID="Panel2" runat="server" Direction="LeftToRight" Height="530px">
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right">ECO5 Account</td>
                                                                    <td width="70px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2" align="left" style="padding-left: 0px;">
                                                                        <asp:CheckBox ID="meter_enabled" runat="server" Enabled="False" Text="Enable Meter" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                        ...
                                        <div style="border-radius: 15px 15px 15px 15px; background-color: #eaf8c7;">
                                            <table width="95%">
                                                <tr>
                                                    <td valign="middle">
                                                        <div class="title_div">
                                                            <asp:Label ID="Label1" Width="190px" runat="server" Text="Undefined meter" Font-Bold="True" ForeColor="#CC0000" Font-Size="Medium" Font-Names="微軟正黑體"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div style="border-radius: 15px 15px 15px 15px; background-color: #ececec;">
                                            <table>
                                                <tr>
                                                    <td valign="middle">
                                                        <div class="title_div">
                                                            <asp:Label ID="Label2" runat="server" Text="Defined Meter" Font-Bold="True" ForeColor="#008C2E" Font-Size="Medium" Font-Names="微軟正黑體"></asp:Label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="show_btn" runat="server" Text="Display" /></td>
                                                </tr>
                                                <tr>
