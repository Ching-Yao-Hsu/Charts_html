<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="MySetup.aspx.vb" Inherits="MySetup" %>
        ...
        function chkName() {
            ...
            if (name != '') {
                ...
                if (regex.test(name) == true) {
                    ...
                    img1.style.visibility = 'visible';
                    div1.innerHTML = "<font color=red>姓名只能含中文英文數字！</font>";
                }
            } else {
        ...
        function chkCompany() {
            ...
            if (company != '') {
                ...
                if (regex.test(company) == true) {
                    ...
                    img2.style.visibility = 'visible';
                    div2.innerHTML = "<font color=red>公司名稱只能含中文英文數字！</font>";
                }
            } else {
                img2.src = "img/error.png";
                img2.style.visibility = 'visible';
                div2.innerHTML = "<font color=red>公司名稱不可為空！</font>";
            }
        }
        ...
        function chkAddress() {
            ...
            if (address != '') {
                ...
                if (regex.test(address) == true) {
                    ...
                    img3.style.visibility = 'visible';
                    div3.innerHTML = "<font color=red>地址只能含中文英文數字！</font>";
                }
            } else {
        ...
        function chkTel() {
            ...
            if (tel != '') {
                ...
                if (regex.test(tel) == true) {
                    ...
                    img4.style.visibility = 'visible';
                    div4.innerHTML = "<font color=red>通訊電話只能含數字！</font>";
                }
            } else {
        ...
        function chkMobile() {
            ...
            if (mobile != '') {
                ...
                if (regex.test(mobile) == true) {
                    ...
                    img5.style.visibility = 'visible';
                    div5.innerHTML = "<font color=red>行動手機只能含數字！</font>";
                }
            } else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="個人資訊" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                    ...
                    <div style="border-radius: 15px 15px 15px 15px; background-color: #e8f0ff; width: 650px;">
                        ...
                        <table>
                            <tr>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="姓名只能含中文英文數字！"
                                    ValidationExpression="^(\w|[\u4E00-\u9FA5])*$" ControlToValidate="Name" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td class="style1">公司名稱
                                </td>
                                <td class="style2" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="公司名稱只能含中文英文數字！"
                            ...
                            <tr>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="地址只能含中文英文數字！"
                                    ValidationExpression="^(\w|[\u4E00-\u9FA5])*$" ControlToValidate="Address" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td class="style1">通訊電話
                                </td>
                                <td class="style2" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="通訊電話只能含數字！"
                                    ValidationExpression="^([0-9]+[^@#$%^&+=_ ])*$" ControlToValidate="Tel" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td class="style1">行動電話
                                </td>
                                <td class="style2" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="行動電話只能含數字！"
                                    ValidationExpression="^([0-9]+[^@#$%^&+=_ ])*$" ControlToValidate="Mobile" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    <asp:Button ID="submit_btn" runat="server" Text="確定" />
