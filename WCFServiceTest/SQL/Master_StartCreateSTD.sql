...
BEGIN
	...
	Exec ('CREATE TABLE [' + @DBName +'].[dbo].[PowerRecordCollection](
	          ...
	          [TotalKWh] [int] NULL,
	          [starKWh] [int] DEFAULT 0 NOT NULL,
	   ...
	   set @sqlstatement = 'CREATE VIEW [dbo].['+ @DBName +'_PowerRecord] AS SELECT  * FROM ['+ @DBName +'].[dbo].[PowerRecord] ';
	   set @sqlstatement01 = 'CREATE VIEW [dbo].['+ @DBName +'_PowerRecordCollection] AS SELECT  * FROM ['+ @DBName +'].[dbo].[PowerRecordCollection] ';
...
CREATE TABLE [dbo].[AdminCom](
	...
	[EnabledTime] [datetime] NOT NULL CONSTRAINT [DF_AdminCom_EnabledTime]  DEFAULT (getdate()),
...
CREATE TABLE [dbo].[AdminSetup](
	...
	[Rank] [int] NOT NULL,
	[GUID] [uniqueidentifier] NOT NULL CONSTRAINT [DF_AdminSetup_GUID]  DEFAULT (newid()),
	[Enabled] [bit] NOT NULL,
	[EnabledTime] [datetime] NOT NULL CONSTRAINT [DF_AdminSetup_EnabledTime]  DEFAULT (getdate()),
...
CREATE TABLE [dbo].[PowerRecord](
	[CtrlNr] [int] NOT NULL,
	[MeterID] [int] NOT NULL,
	[RecDate] [nvarchar](10) NOT NULL,
	[RecTime] [nvarchar](8) NOT NULL,
	[I1] [float] NULL,
	[I2] [float] NULL,
	[I3] [float] NULL,
	[Iavg] [float] NULL,
...
INSERT INTO [dbo].[AdminSetup]
		   ...
		   ,[SumDayMailSent]  ,[SumMonthMailSent] ,[SumDayMail] ,[SumMonthMail],[PerNum])
     VALUES
           ('admin','admin','總管理','最高管理者','艾可智能科技','','03-4625590','','test@mail.com'
		   ,'2','CD89CAC7-B3F1-414E-B493-28F433AEEB2B','1','2013-03-14 13:13:03.463','1','0','0','','',1)
$