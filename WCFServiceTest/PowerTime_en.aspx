<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="PowerTime.aspx.vb" Inherits="PowerTime" %>
                ...
                if ($("#<%= Date_txt1.ClientID%>").val() != "" && $("#<%= Date_txt2.ClientID%>").val() != "") {
                    ...
                    if (j > 0) {
                        if (j <= 10) {
                            ...
                            var HrefAddress = "TimeChart_en.aspx?group=" + group + "&node=" + node + "&datetime1=" + datetime1 + "&datetime2=" + datetime2 + "&interval=" + interval + "&item=" + item + "&value=" + value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="Time interval Comparison Chart" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td align="left">Time interval One
			                                    <asp:TextBox ID="Date_txt1" runat="server" Width="70px" BackColor="White" ForeColor="Black"></asp:TextBox>
                                                <asp:DropDownList ID="begin_hh1" runat="server"></asp:DropDownList>:00
                                                ～
                                                <asp:DropDownList ID="end_hh1" runat="server"></asp:DropDownList>:00
                                            </td>
                                            <td align="left" rowspan="2" width="250px" style="padding-left: 20px;">Time interval
                                        ...
                                        <tr>
                                            <td align="left" colspan="3">Time interval Two
			                                    <asp:TextBox ID="Date_txt2" runat="server" Width="70px" BackColor="White" ForeColor="Black"></asp:TextBox>
                                                <asp:DropDownList ID="begin_hh2" runat="server"></asp:DropDownList>:00
                                                ～             
                                                <asp:DropDownList ID="end_hh2" runat="server"></asp:DropDownList>:00
                                            </td>
                                        </tr>
                                        <tr>
