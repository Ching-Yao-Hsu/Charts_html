<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Record.aspx.vb" Inherits="Chart" %>
        ...
        <asp:Panel ID="Panel_Record" runat="server" Visible="false">
            <div id="Print_Table" class="inner" align="center" style="padding-left: 0px;">
                <table width="800px">
                    <tr>
                        <td align="center">
                            <asp:Label ID="Label2" runat="server" Text="Electricity Numerical record" Font-Bold="true" Font-Size="22px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
