<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="PowerLine.aspx.vb" Inherits="PowerLine" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.support').colorbox({ innerWidth: 745, innerHeight: 600, iframe: true, slideshow: true, scrolling: true, overlayClose: false, href: HrefAddress });
            //月曆
                ...
                if ($("#<%= Date_txt1.ClientID%>").val() != "" && $("#<%= Date_txt2.ClientID%>").val() != "") {
                    ...
                    if (treeViewData != null) {
                        if (treeViewData.selectedNodeID.value != "") {
                            var e = document.getElementById("<%=Account_DropDownList.ClientID%>");
                            ...
                            var HrefAddress = "LineChart.aspx?account=" + account + "&ctrlnr=" + ctrlnr + "&meterid=" + meterid + "&datetime1=" + datetime1 + "&datetime2=" + datetime2 + "&interval=" + interval + "&position=" + position + "&item=" + item + "&value=" + value;
                            $('.imageButtonFinderClass').colorbox({ innerWidth: 910, innerHeight: 550, iframe: true, slideshow: true, scrolling: true, overlayClose: false, href: HrefAddress });
                        } else {
            ...
            $("#<%= submit_btn.ClientID%>").click(function () {
                if ($('select[id$=Account_DropDownList] :selected').val() == "請選擇帳號") {
                    alertify.alert("請選擇帳號");
                    return false;
                }
            });
        });
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                <td align="left" colspan="4" nowrap="nowrap">
                                                                                    <img src="img/icon-account.png" />會員帳號
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="Account_DropDownList" EventName="SelectedIndexChanged" />
