<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SummaryDayReport.aspx.vb" Inherits="SummaryReport" %>
            ...
            <asp:Panel ID="Panel_Report" runat="server">
                <div id="Print_Table" class="inner" style="padding-left: 0px;">
                    <table>
                        <tr>
                            <td align="center">
                                <asp:Label ID="Label2" runat="server" Text="Summary Daily report" Font-Bold="true" Font-Size="22px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
