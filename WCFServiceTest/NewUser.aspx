<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="NewUser.aspx.vb" Inherits="_Default" %>
            ...
            if (account != '') {
                ...
                if (regex1.test(account) == true) {
                    ...
                    if (regex2.test(account) == true) {
                        ...
                        img.style.visibility = 'visible';
                        msg.innerHTML = "<font color=red>帳號字數不符，長度限制 3 ~ 15 字元</font>";
                    }
                } else {
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>帳號不允許特殊符號、數字、英文字母以外的字元</font>";
                }
            } else {
                img.src = "img/error.png";
                img.style.visibility = 'visible';
                msg.innerHTML = "<font color=red>帳號不可為空</font>";
            }
        }
            ...
            if (password != '') {
                ...
                if (regex1.test(password) == true) {
                    ...
                    if (regex2.test(password) == true) {
                        ...
                        img.src = "img/error.png";
                        img.style.visibility = 'visible';
                        msg.innerHTML = "<font color=red>密碼字數不符，長度限制 5 ~ 15 字元</font>";
                    }
                } else {
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
        ...
        var Rpassword = document.getElementById('<%= Page.Master.FindControl("ContentPlaceHolder1").FindControl("Reconfirm_txt").ClientID %>').value;
            if (Rpassword != '') {
                if (Rpassword == password) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>確認密碼錯誤</font>";
                }
            } else {
                img.src = "img/error.png";
                img.style.visibility = 'visible';
                msg.innerHTML = "<font color=red>確認密碼不可為空</font>";
            }
        }
        ...
        function chkCompany() {
            ...
            if (company != '') {
                ...
                if (regex.test(company) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>公司名稱含不合法字元</font>";
                }
            } else {
                img.src = "img/error.png";
                img.style.visibility = 'visible';
        ...
        function chkName() {
            ...
            if (name != '') {
                ...
                if (regex.test(name) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>姓名含不合法字元</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
        ...
        function chkAddress() {
            ...
            if (address != '') {
                ...
                if (regex.test(address) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>地址含不合法字元</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
        ...
        function chkTel() {
            ...
            if (tel != '') {
                ...
                if (regex.test(tel) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>通訊電話含不合法字元</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
        ...
        function chkMobile() {
            ...
            if (mobile != '') {
                ...
                if (regex.test(mobile) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>行動電話含不合法字元</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="新增會員" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                        ...
                        <table style="width:500px">
                            <tr>
                                ...
                                <td align="right" class="style3">
                                    <asp:Label ID="account" runat="server" Text="*會員帳號"></asp:Label>
                                </td>
                                ...
                                <asp:RequiredFieldValidator ID="account_empty" runat="server" ErrorMessage="會員帳號不可為空"
                                    ControlToValidate="account_txt" Display="None"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="帳號需以英文字母作為開頭，只能含有數字與英文，長度限制 3 ~ 15 字元"
                            ...
                            <tr>
                                <td align="right" class="style3" width="30">
                                    <asp:Label ID="password" runat="server" Text="*會員密碼"></asp:Label>
                                </td>
                                ...
                                <asp:RequiredFieldValidator ID="password_empty" runat="server" ErrorMessage="密碼不可為空"
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ErrorMessage="密碼驗證錯誤"
                                    ValidationExpression="^(?!.*[^\x21-\x7e])(?!.*[\[+|\]+$|[\[\]\x22\x27]).*$" ControlToValidate="password_txt" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="Reconfirm" runat="server" Text="*密碼確認"></asp:Label>
                                </td>
                                <td colspan="2" align="left" class="style4">
                                ...
                                <asp:RequiredFieldValidator ID="Reconfirm_empty" runat="server" ErrorMessage="密碼不同"
                                    ControlToValidate="Reconfirm_txt" Display="None"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="密碼不同" ControlToCompare="password_txt"
                                    ControlToValidate="Reconfirm_txt" Display="None"></asp:CompareValidator>
                            </tr>
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="group" runat="server" Text="*群組"></asp:Label>
                                </td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ErrorMessage="群組只能含中文英文數字"
                            ...
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="company" runat="server" Text="*公司名稱"></asp:Label>
                                </td>
                                <td colspan="2" align="left" class="style4">
                            ...
                            <tr>
                                <td class="style3" align="right">
                                    <asp:Label ID="tel" runat="server" Text="通訊電話"></asp:Label>
                                </td>
                                <td colspan="2" align="left" class="style4">
                            ...
                            <tr>
                                <td class="style3" align="right">
                                    <asp:Label ID="mobile" runat="server" Text="行動電話"></asp:Label>
                                </td>
                                <td colspan="2" align="left" class="style4">
                            ...
                            <tr>
                                <td class="style3" align="right">
                                    <asp:Label ID="email" runat="server" Text="*電子郵件"></asp:Label>
                                </td>
                                <td colspan="2" align="left" class="style4">
                            ...
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="rank" runat="server" Text="*權限"></asp:Label>
                                </td>
                                ...
                                <asp:RequiredFieldValidator ID="rank_empty" runat="server" ErrorMessage="權限不可為空"
