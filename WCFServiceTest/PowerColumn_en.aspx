<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="PowerColumn.aspx.vb" Inherits="ColumnChart" MaintainScrollPositionOnPostback="true" %>
                        ...
                        if (diff <= 31) {
                            ...
                            if (j > 0) {
                                if (j <= 10) {
                                    ...
                                    var HrefAddress = "ColumnChart_en.aspx?group=" + group + "&node=" + node + "&begin_time=" + begin_time + "&end_time=" + end_time + "&value=" + value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="Benefit analysis chart" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 8px;">
                                                <asp:RadioButtonList ID="Item_RBList" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="Vavg">Voltage</asp:ListItem>
                                                    <asp:ListItem Value="Iavg">Current</asp:ListItem>
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <div style="height: 50px; padding-top: 5px;">
                                        <asp:ImageButton ID="ViewDetails_btn" runat="server" ImageUrl="~/img/btn_Analysis_01en.png"
                                            onmouseover="this.src='img/btn_Analysis_02en.png'" onmouseout="this.src='img/btn_Analysis_01en.png'"
