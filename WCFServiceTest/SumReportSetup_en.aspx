<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="SumReportSetup.aspx.vb" Inherits="SumReportSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label5" runat="server" Text="Summary Table Setting" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                        ...
                        <table>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                                        <asp:CheckBox ID="sumday_sent" runat="server" Text="Send Summary Daily report" Enabled="False" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                                        <asp:CheckBox ID="summonth_sent" runat="server" Text="Send Summary Monthly report" Enabled="False" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" style="padding-right: 12px;">Email
                            ...
                            <tr>
                                <td align="center" colspan="2" style="padding-top: 10px;">
                                    ...
                                    <asp:Button ID="submit_btn" runat="server" Text="Confirm" OnClientClick="chkAll()" Visible="False" />
                                    &nbsp;&nbsp;&nbsp;
	                                <asp:Button ID="cancel_btn" runat="server" Text="Cancel" CausesValidation="False" Visible="False" />
                                </td>
                            </tr>
                        </table>
                    </div>
