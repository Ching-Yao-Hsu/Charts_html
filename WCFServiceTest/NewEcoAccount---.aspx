<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="NewEcoAccount.aspx.vb" Inherits="NewEcoAccount" %>
	        ...
	        if (EcoAccount != '') {
	            ...
	            if (regex1.test(EcoAccount) == true) {
	                ...
	                if (regex2.test(EcoAccount) == true) {
	                    ...
	                    img.src = "img/error.png";
	                    img.style.visibility = 'visible';
	                    msg.innerHTML = "<font color=red>帳號字數不符，長度限制 15 字元</font>";
	                }
	            } else {
	                img.src = "img/error.png";
	                img.style.visibility = 'visible';
	                msg.innerHTML = "<font color=red>帳號只能含有數字與英文</font>";
	            }
	        } else {
	            img.src = "img/error.png";
	            img.style.visibility = 'visible';
	    ...
	    function chkPosition() {
	        ...
	        if (Position != '') {
	            ...
	            if (regex.test(Position) == true) {
	                ...
	                img.src = "img/error.png";
	                img.style.visibility = 'visible';
	                msg.innerHTML = "<font color=red>位置只能含不合法字元</font>";
	            }
	        } else {
	            img.style.visibility = 'hidden';
	            msg.innerHTML = "";
	        ...
	        if (email != '') {
	            ...
	            if (regex.test(email) == true) {
	                if (count <= 10) {
	                    ...
	                    img8.style.visibility = 'visible';
	                    msg8.innerHTML = "<font color=red>電子郵件不可超過10組</font>";
	                }
	            } else {
	                img8.src = "img/error.png";
	                img8.style.visibility = 'visible';
	                msg8.innerHTML = "<font color=red>電子郵件格式錯誤</font>";
	            }
	        } else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label5" runat="server" Text="新增ECO5帳號" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                        ...
                        <table>
                            <tr>
                                <td align="right" class="style3" width="30">
                                    <asp:Label ID="account" runat="server" Text="*群組"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td align="right" class="style3" width="30">
                                    <asp:Label ID="eco_account" runat="server" Text="*ECO5帳號"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                                ...
                                <asp:RequiredFieldValidator ID="ecoAccount_empty" runat="server" ErrorMessage="ECO5帳號不可為空"
                            ...
                            <tr>
                                <td align="right" class="style3" width="30">
                                    <asp:Label ID="password" runat="server" Text="*ECO5密碼"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="密碼驗證錯誤"
                                    ValidationExpression="^\w{6}$" ControlToValidate="password_txt" Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="Label3" runat="server" Text="ECO5型號"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                            ...
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="ctrlnr" runat="server" Text="ECO5編號"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                            ...
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="drawnr" runat="server" Text="圖面編號"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="圖面編號只能含中文英文數字"
                                    ValidationExpression="^(\w|[\u4E00-\u9FA5]|[^@#$%^&+= ])*$" ControlToValidate="drawnr_txt"
                                    Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="position" runat="server" Text="*安裝位置"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="位置只能含中文英文數字"
                                    ValidationExpression="^(\w|[\u4E00-\u9FA5]|[^@#$%^&+= ])*$" ControlToValidate="position_txt"
                                    Display="None"></asp:RegularExpressionValidator>
                            </tr>
                            <tr>
                                <td align="right" class="style3">
                                    <asp:Label ID="ip" runat="server" Text="*IP位置"></asp:Label>
                                </td>
                                <td class="style4" align="left">
                            ...
                            <tr>
                                <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                    <asp:CheckBox ID="sendnum_enabled" runat="server" Text="事件電話發送" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="padding-right: 12px;">電話號碼
                                </td>
                                <td class="style4" align="left">
                            ...
                            <tr>
                                <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                    <asp:CheckBox ID="sendmail_enabled" runat="server" Text="事件信件發送" />
                                </td>
                            ...
                            <tr>
                                <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                    <asp:CheckBox ID="sendday_enabled" runat="server" Text="寄送日報表" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="padding-right: 12px;">電子信箱
                            ...
                            <tr>
                                <td align="left" colspan="2" class="style3" style="padding-left: 8px;">
                                    <asp:CheckBox ID="sendmonth_enabled" runat="server" Text="寄送月報表" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="padding-right: 12px;">電子信箱
