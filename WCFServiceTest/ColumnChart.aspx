    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=img_btn.ClientID%>").click(function () {
                ...
                //};
                var fileName = '效益分析圖_' + today.getFullYear() + '_' + (today.getMonth() + 1) + '_' + today.getDate() + '.png';
                    ...
                    <tr>
                        <td>
                            <jqChart:Chart ID="PowerColumnChart_V" Width="700px" Height="400px" runat="server" Visible="false">
                                ...
                                <Title Text="效益分析圖"></Title>
                                <Animation Enabled="True" Duration="00:00:01" />
                                <Axes>
                                    <jqChart:LinearAxis Location="Left" Name="Y1">
                                        <Title Text="電壓(V)" Font="14px sans-serif"></Title>
                                    </jqChart:LinearAxis>
                                </Axes>
                                <Series>
                                    <jqChart:ColumnSeries XValuesField="位置" YValuesField="平均值" Title="平均值">
                                    </jqChart:ColumnSeries>
                                    <jqChart:ColumnSeries XValuesField="位置" YValuesField="最大值" Title="最大值">
                                    </jqChart:ColumnSeries>
                                </Series>
                            </jqChart:Chart>
                            <jqChart:Chart ID="PowerColumnChart_I" Width="700px" Height="400px" runat="server" Visible="false">
                                ...
                                <Axes>
                                    <jqChart:LinearAxis Location="Left" Name="Y1">
                                        <Title Text="電流(A)" Font="14px sans-serif"></Title>
                                    </jqChart:LinearAxis>
                                </Axes>
                                <Series>
                                    <jqChart:ColumnSeries XValuesField="位置" YValuesField="平均值" Title="平均值">
