                                        ...
                                        <table width="440px" border="1" rules="rows">
                                            <tr>
                                                <td colspan="4">
                                                    <table width="440px">
                                                        <tr>
                                                                        <td colspan="1" align="left" bgcolor="white" style="padding-left: 20px;">功率 最大值</td>
                                                                        <td colspan="3" align="right" style="padding-right: 20px;">
                                                                            <asp:Label ID="maxW" runat="server" Font-Bold="true" Text="--"></asp:Label>kw</td>
                                                        </tr>
                                                        <tr>
                                                                        <td colspan="1" align="left" bgcolor="white" style="padding-left: 20px;">電壓 最大值</td>
                                                                        <td colspan="3" align="right" style="padding-right: 20px;">
                                                                            <asp:Label ID="maxV" runat="server" Font-Bold="true" Text="--"></asp:Label>V</td>
                                                        </tr>
                                                        <tr>
                                                                        <td colspan="1" align="left" bgcolor="white" style="padding-left: 20px;">電流 最大值</td>
                                                                        <td colspan="3" align="right" style="padding-right: 20px;">
                        ...
                        <td colspan="7">
                            <table width="900px" border="1" rules="all">
                                <tr>
                                    ...
                                    <td colspan="2" align="center">
                                        <asp:Label ID="Label3" runat="server" Text="電表值"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td colspan="2">
                                        <asp:GridView ID="GridView3" runat="server" BackColor="White"
                                            BorderColor="Black" BorderWidth="1px" CellPadding="4"
                                            DataSourceID="SqlDataSource3" ForeColor="Black" GridLines="Horizontal"
                                            Width="340px" BorderStyle="None" AutoGenerateColumns="False">
                                            <Columns>
                                                <asp:BoundField DataField="StarKWh" HeaderText="電表值_起" />
                                                <asp:BoundField DataField="KWh" HeaderText="電表值_迄" />
                                            </Columns>
                                            <RowStyle HorizontalAlign="Center" Wrap="false" />
                                            <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                            <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right"
