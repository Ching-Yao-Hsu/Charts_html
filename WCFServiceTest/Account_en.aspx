<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="Account.aspx.vb" Inherits="Account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="Account Information" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
            ...
            <tr>
                <td align="center" colspan="2">
                    <div style="border-radius: 15px 15px 15px 15px; background-color: #e8f0ff; width: 650px;">
                        <table>
                            <tr>
                                <td class="auto-style1" align="right">Member Account　</td>
                                <td class="style2" align="left">
                                    <asp:Label ID="AccountL" runat="server" Text=""></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style1" align="right">Enable Time　</td>
                                <td class="style2" align="left">
                                    <asp:Label ID="EnabledTime" runat="server" Text=""></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style1" align="right">E-Mail　</td>
                                <td class="style2" align="left">
                            ...
                            <tr>
                                <td align="center" colspan="2" style="width:600px;">
                                    ...
                                    OnClientClick="window.open('Welcome_en.aspx','','menubar=no,status=no,scrollbars=yes,Resizable=yes,width=885px,height=550px').focus();">resend verification letter</asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
