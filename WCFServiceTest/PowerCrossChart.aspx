<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="PowerCrossChart.aspx.vb" Inherits="PowerCrossChart" %>
                        ...
                        if (sum <= 31) {
                            ...
                            if (j >= 2) {
                                if (j <= 4) {
                                    ...
                                    var HrefAddress = "CrossTrendChart.aspx?group=" + group + "&node=" + node + "&begin_time=" + begin_time + "&end_time=" + end_time + "&interval=" + interval + "&item=" + item + "&value=" + value;
                                    ...
                                    alertify.alert("不可勾選超過四個電表");
                                    return false;
                                }
                            } else {
                                alertify.alert("請勾選至少兩個電表");
                                return false;
                            }
                        } else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="多電表趨勢圖" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
