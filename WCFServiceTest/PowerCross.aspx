<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="PowerCross.aspx.vb" Inherits="PowerCross" %>
                ...
                if ($("#<%= Date_Info.ClientID%>").val() != "") {
                    ...
                    if (j > 0) {
                        if (j <= 10) {
                            ...
                            var HrefAddress = "CrossChart.aspx?group=" + group + "&node=" + node + "&datetime=" + datetime;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="電能比對圖" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
