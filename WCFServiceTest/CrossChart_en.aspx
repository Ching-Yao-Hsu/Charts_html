    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=img_btn.ClientID%>").click(function () {
                var today = new Date();
                var fileName = 'Energy Comparison Chart_' + today.getFullYear() + '_' + (today.getMonth() + 1) + '_' + today.getDate() + '.png';
    ...
    <asp:Panel ID="Panel_Chart" runat="server">
            <div id="chart" align="center">
                <jqChart:Chart ID="PowerCrossChart" Width="850px" Height="450px" runat="server" Visible="false">
                    ...
                    <Legend><Title Text="Categories comparison"></Title></Legend>
                    ...
                    <Axes>
                        <jqChart:LinearAxis Location="Left" Name="Y1">
                            <Title Text="Electricity consumption(KWH)" Font="14px sans-serif"></Title>
                        </jqChart:LinearAxis>
                    ...
                    <Series>
                        <jqChart:ColumnSeries XValuesField="Time" YValuesField="Peak_Time" Title="Peak_Time" AxisY="Y1">
                        </jqChart:ColumnSeries>
                        <jqChart:ColumnSeries XValuesField="Time" YValuesField="Half_Peak_Time" Title="Half_Peak_Time" AxisY="Y1">
                        </jqChart:ColumnSeries>
                        <jqChart:ColumnSeries XValuesField="Time" YValuesField="Saturday_Half_Peak_Time" Title="Saturday_Half_Peak_Time" AxisY="Y1">
                        </jqChart:ColumnSeries>
                        <jqChart:ColumnSeries XValuesField="Time" YValuesField="Off_Peak_Time" Title="Off_Peak_Time" AxisY="Y1">
                        </jqChart:ColumnSeries>
                        <jqChart:LineSeries XValuesField="Time" YValuesField="Max_Power" Title="Max_Power" AxisY="Y2" StrokeStyle="#CC6600">
                            <FillStyle Color="#CC6600"></FillStyle>
                        </jqChart:LineSeries>
                        <jqChart:LineSeries XValuesField="Time" YValuesField="Average_Power" Title="Average_Power" AxisY="Y2" StrokeStyle="#00CC00">
