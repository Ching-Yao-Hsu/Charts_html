<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="PowerWeekReport.aspx.vb" Inherits="PowerWeekReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var HrefAddress = "support/PowerWeekReportSupport.htm";
            $('.support').colorbox({ innerWidth: 690, innerHeight: 540, iframe: true, slideshow: true, scrolling: true, overlayClose: false, href: HrefAddress });

            $('.imageButtonFinderClass').click(function () {
                var begin_time = $("#<%= Date_txt1.ClientID %>").val();
                var end_time = $("#<%= Date_txt2.ClientID %>").val();
                        ...
                        if (sum == 6) {
                            ...
                            if (j > 0) {
                                if (j <= 10) {
                                    ...
                                    var HrefAddress = "WeekReport.aspx?group=" + group + "&node=" + node + "&datetime=" + datetime + "&interval=" + interval;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="週報表" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                            ...
                            <tr>
                                ...
                                <%--<td align="left">
			                        ...
			                        <asp:DropDownList ID="interval_DDList" runat="server">
                                        ...
                                        <asp:ListItem Value="5" Selected="True">5分鐘</asp:ListItem>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="height: 50px; padding-top: 5px;">
                                        <asp:ImageButton ID="ViewDetails_btn" runat="server" ImageUrl="~/img/btn_weekly_01.png"
                                            onmouseover="this.src='img/btn_weekly_02.png'" onmouseout="this.src='img/btn_weekly_01.png'"
