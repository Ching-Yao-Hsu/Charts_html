<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="EcoInfo.aspx.vb" Inherits="EcoInfo" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.imageButtonFinderClass').click(function() {
                ...
                var HrefAddress = "EcoTable_en.aspx?eco_account=" + eco_account;
        ...
        function chkDrawnr() {
            ...
            if (Drawnr != '') {
                ...
                if (regex.test(Drawnr) == true) {
                    ...
                    img.src = "img/error.png";
                    img.style.visibility = 'visible';
                    msg.innerHTML = "<font color=red>Drawing No. contains illegal characters.</font>";
                }
            } else {
                img.style.visibility = 'hidden';
                msg.innerHTML = "";
            ...
            if (mobile != '') {
	            ...
	            if (regex.test(mobile) == true) {
	                if (count <= 10) {
	                    ...
	                    img.src = "img/error.png";
	                    img.style.visibility = 'visible';
	                    msg.innerHTML = "<font color=red>hone number is not more than 10 group.</font>";
	                }
	            } else {
	                img.src = "img/error.png";
	                img.style.visibility = 'visible';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="ECO5 Account Settings" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    <td valign="top">
                                        <div style="border-radius: 15px 15px 15px 15px; background-color: #e8f0ff; height:650px">
                                            <table>
                                                <tr>
                                                    <td colspan="2" align="left" valign="middle">
                                                        <div class="title_div">
                                                            <asp:Label ID="Label3" Width="190px" runat="server" Text="ECO5 information" Font-Bold="True" Font-Names="微軟正黑體" Font-Size="Medium"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Button ID="edit_btn" runat="server" Text="Update" OnClientClick="chkDrop()" />
                                                        <asp:Button ID="submit_btn" runat="server" Text="Confirm" Enabled="False" />
                                                        <asp:Button ID="cancel_btn" runat="server" Text="Cancel" Enabled="False" CausesValidation="False" />
                                                        <asp:Button ID="delete_btn" runat="server" Text="Delete" Visible="False" OnClientClick="return confirm('Confirm that you want to delete? Including meter data be deleted.');" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Password validation error."
                                                                    ValidationExpression="^\w{6}$" ControlToValidate="eco5_password" Display="None"></asp:RegularExpressionValidator>
                                                            </tr>
                                                            <tr>
                                                                <td class="td_width" align="right">Drawing No</td>
                                                            ...
                                                            <tr>
                                                                <td class="td_width" align="right" nowrap="nowrap">*Installation location</td>
                                                            ...
                                                            <tr>
                                                                <td class="td_width" align="right">*IP Location</td>
                                                                <td colspan="3" class="auto-style2" align="left">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="left" style="padding-left: 10px;">
                                                                    <asp:CheckBox ID="eco_enabled" runat="server" Enabled="False" Text="Enable ECO5" />
                                                                </td>
                                                                <td class="td_width" align="right">Time difference</td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="left" style="padding-left: 10px;">
                                                                    <asp:CheckBox ID="sendnum_enabled" runat="server" Enabled="False" Text="Event sending by Phone" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="td_width" align="right">Telephone number</td>
                                                                <td colspan="3" align="left">
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="left" style="padding-left: 10px;">
                                                                    <asp:CheckBox ID="sendmail_enabled" runat="server" Enabled="False" Text="Event sending by Phone" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="td_width" align="right">Email</td>
                                                                <td colspan="3" align="left">
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="left" style="padding-left: 10px;">
                                                                    <asp:CheckBox ID="sendday_enabled" runat="server" Enabled="False" Text="Send Daily Report" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="td_width" align="right">Email
                                                                </td>
                                                                <td colspan="3" align="left">
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="left" style="padding-left: 10px;">
                                                                    <asp:CheckBox ID="sendmonth_enabled" runat="server" Enabled="False" Text="Send Monthly Report" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="td_width" align="right">Email
                                        ...
                                        <div style="border-radius: 15px 15px 15px 15px; background-color: #eaf8c7;">
                                            <table>
                                                <tr>
                                                    <td valign="middle">
                                                        <div class="title_div">
                                                            <asp:Label ID="Label1" runat="server" Text="ECO5 List" Font-Bold="True" ForeColor="#CC0000" Font-Size="Medium" Font-Names="微軟正黑體"></asp:Label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Panel ID="Panel1" runat="server" Height="615px" Width="350px" Direction="LeftToRight" ScrollBars="Auto">
