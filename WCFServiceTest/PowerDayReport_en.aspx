<%@ Page Title="" Language="VB" MasterPageFile="~/index_en.master" AutoEventWireup="false" CodeFile="PowerDayReport.aspx.vb" Inherits="PowerDayReport" %>
                ...
                if ($("#<%= Date_txt.ClientID%>").val() != "") {    
                    ...
                    if (j > 0) {
                        if (j <= 10) {
                            ...
                            var HrefAddress = "DayReport_en.aspx?group=" + group + "&node=" + node + "&datetime=" + datetime + "&interval=" + interval;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="Daily Report" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <div style="height: 50px; padding-top: 5px;">
                                        <asp:ImageButton ID="ViewDetails_btn" runat="server" ImageUrl="~/img/btn_dailyreport_01en.png"
                                            onmouseover="this.src='img/btn_dailyreport_02en.png'" onmouseout="this.src='img/btn_dailyreport_01en.png'"
