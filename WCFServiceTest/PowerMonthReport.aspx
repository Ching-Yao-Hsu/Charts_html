<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="PowerMonthReport.aspx.vb" Inherits="PowerMonthReport" %>
                ...
                if ($("#<%= Date_txt.ClientID%>").val() != "") {
                    ...
                    if (j > 0) {
                        if (j <= 10) {
                            ...
                            var HrefAddress = "MonthReport.aspx?group=" + group + "&node=" + node + "&datetime=" + datetime + "&interval=" + interval;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content" align="center">
        <table>
            <tr>
                <td align="left">
                    <asp:Label ID="Label2" runat="server" Text="月報表" Font-Bold="True" Font-Size="16pt" CssClass="fontline"></asp:Label>
                </td>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="height: 50px; padding-top: 5px;">
                                        <asp:ImageButton ID="ViewDetails_btn" runat="server" ImageUrl="~/img/btn_monthreport_01.png"
                                            onmouseover="this.src='img/btn_monthreport_02.png'" onmouseout="this.src='img/btn_monthreport_01.png'"
