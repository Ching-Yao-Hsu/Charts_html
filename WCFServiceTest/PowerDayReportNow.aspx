<%@ Page Title="" Language="VB" MasterPageFile="~/Power.master" AutoEventWireup="false" CodeFile="PowerDayReportNow.aspx.vb" Inherits="PowerDayReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //月曆
            $("#<%= Date_Info.ClientID%>").datepicker({ dateFormat: 'yy/mm/dd', showOn: 'button',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="LoadingMessage" align="center" style="font-size: 14px; width: 1000px; height: 100%; background: url('img/blank1.png') repeat-y; position: absolute; display: none; z-index: 9999">網頁載入中，請稍候...</div>
    ...
    <asp:Panel ID="panContent" runat="server" Width="880px" Style="padding-left: 30px;">
        <table width="880px">
            <tr>
                <td>
                    <div style="border-radius: 15px 15px 15px 15px;background-color:#e8f0ff; width:500px;">
                        <table>
                            <tr>
                                <td>
                                    <img src="img/date2.png" />日期
                                    <asp:TextBox ID="Date_Info" runat="server" Width="70px"></asp:TextBox></td>
                        ...
                        <table width="900px" border="0">
                            <tr>
                                <td colspan="8" align="center">
                                    <asp:Label ID="Label2" runat="server" Text="日報表" Font-Bold="true" Font-Size="22px"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                                    ...
                                    <table width="440px" border="1" rules="rows">
                                        <tr>
                                            <td colspan="4" align="center" bgcolor="#333333">
                                                <asp:Label ID="Label1" runat="server" Text="用電量" ForeColor="White" Font-Bold="true" Font-Size="14px"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
                    ...
                    <td colspan="4" width="440px">
                        <table width="440px" border="1" rules="rows">
                            <tr>
                                <td colspan="4" align="center" bgcolor="#333333">
                                    <asp:Label ID="W" runat="server" Text="功率" Font-Bold="true" ForeColor="White" Font-Size="14px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <table width="440px" bgcolor="white">
                            ...
                            <tr>
                                <td colspan="4" align="center" bgcolor="#333333">
                                    <asp:Label ID="V" runat="server" Text="電壓" Font-Bold="true" ForeColor="White" Font-Size="14px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <table width="440px" bgcolor="white">
                            ...
                            <tr>
                                <td colspan="4" align="center" bgcolor="#333333">
                                    <asp:Label ID="A" runat="server" Text="電流" Font-Bold="true" ForeColor="White" Font-Size="14px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <table width="440px" bgcolor="white">
