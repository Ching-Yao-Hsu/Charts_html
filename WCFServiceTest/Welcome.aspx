    ...
    <form id="form1" runat="server">
        <div id="all">
            ...
            <div id="content" align="center">
                ...
                <br />
                <br />
                <asp:Label ID="Label2" runat="server" Text="重寄驗證信" Font-Bold="True" Font-Size="13pt" CssClass="fontline"></asp:Label>
                <br />
                <br />
                <div align="center">
                    帳號
                ...
                <br />
                <div align="center">
                    <asp:Button ID="Send" runat="server" Text="寄送驗證信" Height="35px" Width="100px" />
                </div>
                <br /><br /><br /><br /><br /><br />
            </div>
            <div id="FOOTER">
